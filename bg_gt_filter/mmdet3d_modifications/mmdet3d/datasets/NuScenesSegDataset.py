...
with open('/mmdetection3d/data/nuscenes/v1.0-trainval/category.json') as cat_file:
...
# O código original está em https://github.com/open-mmlab/mmdetection3d/blob/main/mmdet3d/datasets/nuscenes_dataset.py
# Apenas a classe foi modificada para adicionar os rotulos de pontos
@DATASETS.register_module()
class NuScenesSegDataset(Det3DDataset):
    r"""NuScenes Dataset.
    ...
    METAINFO = {
        ...
        'seg_valid_class_ids': classes_idxes,
        'seg_all_class_ids': classes_idxes
    }
...
BACKGROUND_CLASSES_NAMES = [
    'noise', 'movable_object.barrier', "movable_object.debris", "movable_object.pushable_pullable", "movable_object.trafficcone", 
...
def is_bg_point_class_name(class_name):
    return class_name in BACKGROUND_CLASSES_NAMES