...
data_prefix = dict(
    pts='samples/LIDAR_TOP_GT_FILTERED_10_sweeps_1x_voxel', 
    img='', 
    sweeps=''
)
...
model = dict(
    type='MVXFasterRCNN',
    data_preprocessor=dict(type='Det3DDataPreprocessor', voxel_layer=dict(max_num_points=20, deterministic=False)),
